      ...
      <div className={styles.product_page}>
        <section className={styles.hero_section}>
          ...
          <div className={styles.product_info}>
            ...
            <p>Stock Available</p>
            <Link href={`//api.whatsapp.com/send?phone=2349085323596&text=Hi+MedPau+International.+I'm+interested+in+buyng+${product.name}.+How+much+does+it+cost?`}  target="_blank"><Button variant="contained" className={styles.addtocart_btn}>
              Place Order
            </Button>
            </Link>
          </div>
...
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Varius massa id ut mattis. Facilisis vitae gravida egestas ac account.</p>
        ...
        <div className={styles.related_products}>
          ...
          <div className={styles.item_cards}>
            ...
            {products.filter(eachProduct=> eachProduct.category === product.category).map(relatedProduct=><div className={styles.item} key={relatedProduct.id}>
              <ItemCard
